...
@interface RKSTTaskViewController : UIViewController<RKSTStepViewControllerDelegate>
 ...
 */
-(instancetype)initWithTask:(id<RKSTTask>)task taskRunUUID:(NSUUID *)taskRunUUID  NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithCoder:(NSCoder *)aDecoder NS_DESIGNATED_INITIALIZER;

- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil NS_DESIGNATED_INITIALIZER;

@property (nonatomic, weak) id<RKSTTaskViewControllerDelegate> delegate;
