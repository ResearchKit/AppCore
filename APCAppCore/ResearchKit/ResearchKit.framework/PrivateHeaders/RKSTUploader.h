...
@interface RKSTUploader : NSObject
...
/**
 * @brief Queues data for sending using the RKSTUploader.
 *
 ...
 *
 */
- (BOOL)queueArchive:(RKSTDataArchive *)archive error:(NSError * __autoreleasing *)errorOut;
