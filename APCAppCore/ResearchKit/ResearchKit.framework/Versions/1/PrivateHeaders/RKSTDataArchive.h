 ...
 */
@interface RKSTDataArchive : NSObject
 ...
 *
 * @discussion Adding a file to an RKSTDataArchive, or requesting archive data or
...
@interface RKSTDataArchive (RKSTDataLoggerManager)
 ...
 *
 */
+ (NSURL *)makeArchiveFromDataLoggerManager:(RKSTDataLoggerManager *)manager
 ...
 *
 */
+ (NSData *)makeEncryptedArchiveFromDataLoggerManager:(RKSTDataLoggerManager *)manager
                                       itemIdentifier:(NSString *)itemIdentifier
                                      studyIdentifier:(NSString *)studyIdentifier
                                       fileProtection:(RKFileProtectionMode)fileProtection
                                    maximumInputBytes:(unsigned long long)maxBytes
