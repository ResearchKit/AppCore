//
//  RKSTActiveStepViewController.h
//  ResearchKit
//
...
/**
 * @brief Step view controller for an RKSTActiveStep.
 */
RK_CLASS_AVAILABLE_IOS(8_3)
@interface RKSTActiveStepViewController : RKSTStepViewController<RKSTRecorderDelegate>
