 ...
 * is normally presented using RKSTStepViewController.
 */
RK_CLASS_AVAILABLE_IOS(8_3)
@interface RKSTStep : NSObject <NSSecureCoding, NSCopying>
 ...
 * @discussion This is normally set when a step is added to RKSTOrderedTask. When
 * implementing a custom task, it may be helpful to set that task
 * here.
 */
@property (nonatomic, weak) id<RKSTTask> task;
