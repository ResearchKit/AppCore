...
- (ORKOrderedTask *)makeLongTask {
    ...
    
    {
        ...
        step.shouldUseNextAsSkipButton = YES;
        step.recorderConfigurations = @[[ORKTouchRecorderConfiguration configuration]];
        [steps addObject:step];
    }
...
- (ORKOrderedTask *)makeConsentSignatureTask {
    ...
    ORKOrderedTask *task = [[ORKOrderedTask alloc] initWithIdentifier:ConsentReviewTaskIdentifier steps:@[reviewStep]];
    return task;
}
...
- (id<ORKTask>)makeScreeningTask {
    ...
    {
        ORKMediaStep *step = [[ORKMediaStep alloc] initWithIdentifier:@"itid_004"];
...
- (ORKConsentDocument*)buildConsentDocument{
    ...
    ORKConsentSignature *investigatorSig = [ORKConsentSignature signatureForPersonWithTitle:@"Investigator" dateFormatString:nil identifier:@"investigatorSig" firstName:@"Jake" lastName:@"Clemson" signatureImage:[UIImage imageNamed:@"signature.png"] dateString:@"9/2/14" ];
...
- (void)beginTask:(id<ORKTask>)task
{
