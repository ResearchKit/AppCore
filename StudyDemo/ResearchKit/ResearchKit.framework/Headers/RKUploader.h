...
/*!
 * @brief Specifies how uploaded data should be archived for upload.
 */
@property (readonly) RKDataArchiveFormat archiveFormat;
 ...
 *
 */
- (BOOL)sendArchive:(RKDataArchive *)archive error:(NSError * __autoreleasing *)errorOut;
