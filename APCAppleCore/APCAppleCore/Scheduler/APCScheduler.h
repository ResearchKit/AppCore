...
- (void)updateScheduledTasksIfNotUpdating: (BOOL) today OnCompletion:(void (^)(NSError *))completionBlock; //If today is not set, it will always update tasks for tomorrow
