...
/**
 * @brief RKHealthKitCharacteristicTypeAnswerFormat requests a characteristic value, depending on the HealthKit type requested.
 *
 ...
 */
@interface RKHealthKitCharacteristicTypeAnswerFormat : RKAnswerFormat
...
/**
 * @brief RKHealthKitQuantityTypeAnswerFormat requests a quantity value, depending on the HealthKit type requested.
 *
 * @discussion The actual UI used for collecting data with this answer format depends on the HealthKit type being collected.
 * The default value in the UI will be the most recent value pulled from HealthKit, if such a value exists.
 * When a step or item is presented using this answer format, authorization will be requested.
 ...
 */
@interface RKHealthKitQuantityTypeAnswerFormat : RKAnswerFormat
